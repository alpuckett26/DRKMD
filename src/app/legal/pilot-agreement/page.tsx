    ...
    <div className="min-h-screen pb-16">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-8 space-y-8 text-sm text-gray-700 leading-relaxed">
        ...
        <div className="card border-yellow-800/40 space-y-2">
          <p className="text-yellow-700 text-xs font-semibold">PILOT / TRIAL AGREEMENT</p>
          <p className="text-xs text-gray-500">This Pilot Agreement governs your participation in the WendOS pilot program. It supplements — and in the event of conflict, is superseded by — the WendOS Platform Service Agreement. Capitalized terms not defined here have the meaning given in the Service Agreement.</p>
        </div>

        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">1. Pilot Period</h2>
          ...
          <ul className="space-y-1.5 ml-4 mt-2">
            <li>• The monthly platform subscription fee ($99/mo) is <strong className="text-green-700">waived</strong>.</li>
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">2. Hardware During Pilot</h2>
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">3. Conversion to Paid Plan</h2>
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">4. Early Termination</h2>
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">5. No Guarantee</h2>
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">6. Store Responsibilities During Pilot</h2>
          <p>Store agrees to:</p>
          <ul className="space-y-2 ml-4 mt-2">
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">7. Relationship to Service Agreement</h2>
        ...
        <div className="space-y-3">
          <h2 className="font-black text-base text-gray-900 border-b border-gray-200 pb-2">8. Confidentiality</h2>
        ...
        <div className="card border-brand/20 text-center space-y-2">
          <p className="text-xs text-gray-500">Interested in the pilot program? Contact us at <strong className="text-gray-700">hello@wendos.com</strong></p>
